...
async def pm_text(bot, message):
    ...
    if PM_SEARCH == False:
        ...
        await message.reply_text(text=f"<b>ʜᴇʏ {user} 😍 ,\n\nʏᴏᴜ ᴄᴀɴ'ᴛ ɢᴇᴛ ᴍᴏᴠɪᴇs ꜰʀᴏᴍ ʜᴇʀᴇ. ʀᴇǫᴜᴇsᴛ ɪᴛ ɪɴ ᴏᴜʀ <a href=https://t.me/Prime_Movies4U/143>ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ</a> ᴏʀ ᴄʟɪᴄᴋ ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ 👇</b>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ", url=f"https://t.me/Prime_Movies4U/143")]]))
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data == "close_data":
        ...
        if not free_trial_status:            
            ...
            new_text = "**ʏᴏᴜ ᴄᴀɴ ᴜsᴇ ꜰʀᴇᴇ ᴛʀᴀɪʟ ꜰᴏʀ 5 ᴍɪɴᴜᴛᴇs ꜰʀᴏᴍ ɴᴏᴡ 😀\n\nআপনি এখন থেকে 5 মিনিটের জন্য প্রিমিয়াম ফিচারস বিনামূল্যে ট্রায়াল ব্যবহার করতে পারবেন এর মধ্যে কোন অ্যাড আসবে না 😀**"        
            await query.message.edit_text(text=new_text)
            return
        else:
            new_text= "**🤣 you already used free now no more free trail. please buy subscription here are our 👉 /plan \n\n আপনি ইতিমধ্যে বিনামূল্যে ব্যবহার করেছেন এখন আর বিনামূল্যের পথ নেই। সাবস্ক্রিপশন কিনতে হবে দয়া করে । এখানে আমাদের প্লেন দেখার জন্য 👉 /plan **"
            await query.message.edit_text(text=new_text)
            return
