...
Join My <a href='https://telegram.dog/Prime_botz'>Update Channel</a> For More Update Regarding Repo.</b>
...
### Optional Variables
* <b>`PICS`: Telegraph links of images to show in start message. You can use Our Img to link bot For Create Your Image to url  [img To Url Bot](Https://telegram.me/iMg_To_URL_Prime_Bot).( Multiple images can be used separated by space )
